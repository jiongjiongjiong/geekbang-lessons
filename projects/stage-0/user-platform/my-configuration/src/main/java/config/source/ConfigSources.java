...
public class ConfigSources implements Iterable<ConfigSource> {
    ...
    public void addDefaultSources() {
        ...
        addConfigSources(org.geektimes.configuration.microprofile.config.source.JavaSystemPropertiesConfigSource.class,
                org.geektimes.configuration.microprofile.config.source.OperationSystemEnvironmentVariablesConfigSource.class,
                org.geektimes.configuration.microprofile.config.source.DefaultResourceConfigSource.class
        );
    ...
    public void addConfigSources(Iterable<ConfigSource> configSources) {
        ...
        sort(this.configSources, org.geektimes.configuration.microprofile.config.source.ConfigSourceOrdinalComparator.INSTANCE);
    }
